...
app.use(cors({
  origin: [
    'https://politicalgossips.vercel.app',    // Production frontend
    'https://www.politicalgossips.vercel.app', // Production frontend with www
    process.env.FRONTEND_URL || 'http://localhost:5173' // Development frontend
  ],
